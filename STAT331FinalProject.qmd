...
The P - value is extremely small (p\<0.05), which indicates the data is statistically significant.

$R^2$ is 0.7618452, which means the simulated data can explain around 76% of the variation in observed data. In this case, we suppose that the one time simulation till now did a moderately good job.
...
While the Earth may seem prosperous to us today, there is only a finite amount of resources, and life, on the planet and the human population just hit 8 billion. Global temperature continue to increase threatening many living organisms. Protecting humanity's environment should be number one priority and thought of with every decision made. Energy use, as well CO2 emissions, is also on the rise while the amount of renewable energy the world is using is decreasing. 
...
1 
https://www.gapminder.org/data/ https://plotly.com/r/line-and-scatter/#custom-color-scales https://datascott.com/blog/subtitles-with-ggplotly/ https://statisticsglobe.com/ggplotly-function-r#:\~:text=In%20this%20one%2C%20you%E2%80%99ll%20learn%20how%20to%20use,Graph%20to%20Interactive%20plotly%20Graph%20%28Line%20Plot%20Example%29 1. https://www.gapminder.org/data/ https://plotly.com/r/line-and-scatter/#custom-color-scales
