...
The graph displayed on the top demonstrates the relationship between Total Co2 Emissions and Percent Renewable Energy, shown by plotting the raw data.  The distribution illustrates a negative pattern with considerable noise, explained by the smallest countries and relative values of Total Co2 Emissions.  To better visualize how the relationship between Co2 Emissions and Percent Renewable Energy differentiates for the four largest producers of Co2, we filtered to only include India, Russia, US, and China in the second plot.  In doing this, we were able to take out countries with insignificant Co2 emissions, as the model better explained the variability \$\$R\^{2}\$\$ in Co2 emissions for the top countries.  Essentially, we were able to see that there needs to be a minimum amount of Total_Co2_Emission data, in order for the model to be accurate in making conclusions about the variable's relationship.   
